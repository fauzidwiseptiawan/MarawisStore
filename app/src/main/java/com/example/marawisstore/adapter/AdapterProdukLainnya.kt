...
class AdapterProdukLainnya(var activity: Activity, var data:ArrayList<Produk>): RecyclerView.Adapter<AdapterProdukLainnya.Holder>() {

    class Holder(view: View) : RecyclerView.ViewHolder(view) {
        val tvNamaProduk = view.findViewById<TextView>(R.id.tv_nama_produk_lainnya)
        val tvHargaProduk = view.findViewById<TextView>(R.id.tv_harga_produk_lainnya)
        val tvDiskon = view.findViewById<TextView>(R.id.tv_diskon)
        val imgProduk = view.findViewById<ImageView>(R.id.img_produk_lainnya)
        val layoutProdukLainnya = view.findViewById<CardView>(R.id.layout_produk_lainnya)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val view: View =LayoutInflater.from(parent.context).inflate(R.layout.item_produk_lainnya,parent,false)
        return Holder(view)
    }
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.layoutProdukLainnya.setOnClickListener {
